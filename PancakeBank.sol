...
contract PancakeBank is IBankDistributor {
    IMasterChef constant cakeMasterchef = IMasterChef(0x73feaa1eE314F8c655E354234017bE2193C9E24E);
    IERC20 constant cake = IERC20(0x4c6d40a7a88beE8690949Dc7EE6Fd0cf22C29603);
    ...
    function poolCount() external view override returns (uint256) {
        return cakeMasterchef.poolLength();
    }
    ...
    function lockableToken(uint256 poolId) external view override returns (IERC20) {
        (IERC20 lpToken,,,) = cakeMasterchef.poolInfo(poolId);
        return lpToken;
    }

    function lockedAmount(address user, uint256 poolId) external view override returns (uint256) {
        (uint256 amount,) = cakeMasterchef.userInfo(poolId, user);
        return amount;
    }
